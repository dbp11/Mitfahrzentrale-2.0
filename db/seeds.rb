...
#Creates request
req1 = Request.new :starts_at_N => 48.1391265, :starts_at_E => 11.5801863, :ends_at_N => 53.074981, :ends_at_E => 8.807081, :start_city => "München",:start_zipcode => 80539,:start_street=>"", :end_city => "Bremen", :end_zipcode => 48431, :end_street=>"", :start_time => Time.now+1.minutes, :end_time => Time.now+365.day, :baggage => true, :comment => "Hilfe", :user_id => 1, :start_radius => 31, :end_radius => 37
req2 = Request.new :starts_at_N => 48.1391265, :starts_at_E => 11.581863, :ends_at_N => 53.074981, :ends_at_E => 8.807081, :start_city => "Hamburg",:start_zipcode => 80539,:start_street=>"" , :end_city => "Berlin",:end_zipcode => 28195,:end_street => "", :start_time => Time.now+1.minutes, :end_time => Time.now+365.day, :baggage => false, :comment => "Hilfe", :user_id => 2, :start_radius => 12, :end_radius => 15
...
tri2 = Trip.new :user_id => 2, :car_id => 2, :starts_at_N => 48.1391265, :starts_at_E => 11.5801863, :ends_at_E => 8.807081, :ends_at_N => 53.074981, :start_city => "München", :start_zipcode => 80539, :start_street => "", :end_city => "Bremen", :end_zipcode => 28195, :end_street => "", :start_time => Time.now+1.day, :comment => "Platz für alle :D!", :baggage => true, :free_seats => 4
...
sleep(1.minutes)
#Creates ratings
ra1 = Rating.new :comment => "Auto im schlechten Zustand!", :mark => 1, :trip_id => 1, :receiver_id => 1, :author_id => 2
