...
#Creates request
req1 = Request.new :starts_at_N => 48.1391265, :starts_at_E => 11.5801863, :ends_at_N => 52.2766061, :ends_at_E => 7.43844030000001, :start_city => "München",:start_zipcode => 80539,:start_street=>"", :end_city => "Bremen", :end_zipcode => 48431, :end_street=>"", :start_time => Time.now+1.minutes, :end_time => Time.now+365.day, :baggage => true, :comment => "Hilfe", :user_id => 1, :start_radius => 31, :end_radius => 37
